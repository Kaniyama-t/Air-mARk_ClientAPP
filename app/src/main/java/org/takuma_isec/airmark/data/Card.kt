...
class Card (var context: Context, val name: String, val Twitter: String?, val Facebook: String?, val Github:String?, val othersSNS: HashMap<String,String>?, val ThreeDObjectURL: URL?, val ThreeDObject: Renderable){
